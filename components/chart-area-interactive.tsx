...
export function ChartAreaInteractive() {
  ...
  return (
    <Card className="@container/card border-purple-400/30 bg-gradient-to-br from-purple-900/40 to-slate-900/40 backdrop-blur-sm shadow-lg shadow-purple-900/20 hover:border-purple-400/50 transition-all duration-300">
      <CardHeader>
        <CardTitle className="text-white">Total des Visiteurs</CardTitle>
